...
Vector Matrix::operator*(const Vector & v) const{
    ...
    return Vector(matrixData[0]*v.x+matrixData[3]*v.y+matrixData[6]*v.z,
...
Vector Matrix::transformVectorByMatrix(const Vector& v) const{
...
void Matrix::setMatrixAsIdentityMatrix(){
...
float Matrix::getMatrixDeterminant() const{
...
void Matrix::invertAndTransposeMatrix(){
...
void Matrix::makeRotationMatrixAboutXAxisByAngle(float uAngle){
...
void Matrix::makeRotationMatrixAboutYAxisByAngle(float uAngle){
    ...
    Matrix m(cos(uAngle),0.0,sin(uAngle),
                  0.0,1.0,0.0,
...
void Matrix::makeRotationMatrixAboutZAxisByAngle(float uAngle){
    ...
    Matrix m(cos(uAngle),-sin(uAngle),0.0,
...
void Matrix::transformMatrixAboutXAxisByAngle(float uAngle){
...
void Matrix::transformMatrixAboutYAxisByAngle(float uAngle){
...
void Matrix::transformMatrixAboutZAxisByAngle(float uAngle){
